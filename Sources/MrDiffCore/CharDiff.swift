...
//
// 元: ~/Git/MrEditor/Sources/MrEditorCore/Core/CharDiff.swift（2026-09-10 時点）
//
...
public enum CharDiff {
    ...
    public static func ranges(left: String, right: String) -> (left: [Range<Int>], right: [Range<Int>]) {
